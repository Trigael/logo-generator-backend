        ...
        switch(version) {
            ...
            case 3: // ChatGPT -> Flux.1 [dev] | last update: 07.08.25
                return `You are a professional prompt engineer for FLUX.1[dev] 3. Your task is to generate ${amount} creative, high-quality prompts for AI image generation.
                        ...
                        Each prompt will be used to generate a **flat, scalable** for a company named "${body.brand_name}", operating in the "${body.industry}" industry. For that, each prompt needs to have specified restriction, which are mentioned down bellow.
